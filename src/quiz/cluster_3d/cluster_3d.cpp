...
int main ()
{
	...
	// Create data
	std::vector<std::vector<float>> points = { {-6.2,7,1.1}, {-6.3,8.4,1.4}, {-5.2,7.1,1.05}, {-5.7,6.3,1.6}, {7.2,6.1,3.4}, {8.0,5.3,3.7}, {7.2,7.1,2.9}, {0.2,-7.1,-2.0}, {1.7,-6.9,-2.2}, {-1.2,-7.2,-2.1}, {2.2,-8.9,-2.15} };
